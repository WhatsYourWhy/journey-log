...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function normalizeTasks(parsedTasks) {
        ...
        return parsedTasks
            ...
            .map((task) => ({
                ...
                id: typeof task.id === 'number' ? task.id : now + fallbackCounter++,
    ...
    function loadTasks() {
        ...
        try {
            ...
            if (normalized.length !== (Array.isArray(parsed) ? parsed.length : 0)) {
                ...
                console.warn('Some saved Journey Log tasks were reset due to invalid data.');

                localStorage.setItem('journeyTasks', JSON.stringify(normalized));
            ...
            console.warn('Unable to read saved Journey Log tasks. Resetting storage.', error);
